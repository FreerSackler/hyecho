...
class SKMultilineLabel: SKNode {
    ...
    init(text:String, labelWidth:Int, pos:CGPoint, fontName:String="AvenirNext-Medium",fontSize:CGFloat=10,fontColor:UIColor=UIColor.black,leading:Int? = nil, alignment:SKLabelHorizontalAlignmentMode = .center, shouldShowBorder:Bool = false)
    {
        self.text = text
