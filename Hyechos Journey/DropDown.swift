...
public final class DropDown: UIView {
	...
	*/
	public dynamic var selectionBackgroundColor = UIColor.clear
	...
	*/
    ...
    public func changeCellColor(sender : UIColor) {
        tableView.backgroundView?.backgroundColor = sender
        tableView.backgroundColor = sender
    }
