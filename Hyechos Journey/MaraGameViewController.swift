...
class MaraGameViewController: UIViewController{
    
    @IBOutlet weak var gameView: SKView!
    
    //lets us have a reference to the scene
    var scene = MaraGameScene()
    ...
    override func viewDidLoad() {
        ...
        let scene = SKScene(fileNamed: "newMaraGameScene") as! MaraGameScene
